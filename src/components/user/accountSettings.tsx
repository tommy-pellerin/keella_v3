    ...
    <>
      ...
      <div className="container mx-auto my-5">
        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-5 place-items-center">
          ...
          <Link to={`/account-settings/personal-infos/`} className="border border-blue-700 rounded-lg bg-blue-500 bg-opacity-70 hover:bg-blue-500 px-3 py-3 w-3/5 sm:h-52 lg:h-44">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z" />
                </svg>
              ...
              <div className="text-center">
                <h2 className="border-b border-white text-white">Mes informations personnelles</h2>
                <h3>Retrouver vos informations.</h3>
              </div>
          </Link>

          <Link to={`/account-settings/${user.id}/my-reservation`} className="border border-green-700 rounded-lg bg-green-500 bg-opacity-70 hover:bg-green-500 px-3 py-3 w-3/5 sm:h-52 lg:h-44">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10">
          ...
          <Link to={`/account-settings/${user.id}/hosted_workouts`} className="border border-red-700 rounded-lg bg-red-500 bg-opacity-70 hover:bg-red-500 px-3 py-3 w-3/5 sm:h-52 lg:h-44">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10">
